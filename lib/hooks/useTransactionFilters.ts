...
import { getMonthKey, safeDate, getCategoryPath } from "@/lib/utils/dashboard";
...
export const useTransactionFilters = ({
  ...
  const getFilteredAndSortedCategories = useMemo(() => {
    ...
    let filtered = categories.filter(cat => {
      // Wyklucz kategorie z is_expanded (kategorie nadrzędne)
    ...
    return filtered;
  }, [categories, categorySearchFilter, categoryMatchesFilter]);
